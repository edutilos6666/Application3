...
public class FragmentWorkerForm_LM extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_worker_form_lm, container, false);
        return v;
    }
    ...
    private void initComponents() {
        editId = (EditText) getView().findViewById(R.id.worker_lm_editId);
        editName = (EditText) getView().findViewById(R.id.worker_lm_editName);
        editPassword = (EditText) getView().findViewById(R.id.worker_lm_editPassword);
      /*  editAge = (EditText) getView().findViewById(R.id.worker_lm_editAge);
        editWage = (EditText) getView().findViewById(R.id.worker_lm_editWage);
        editActive = (EditText) getView().findViewById(R.id.worker_lm_editActive);*/
        btnSubmit = (Button) getView().findViewById(R.id.worker_lm_btnSubmit);
        btnClear = (Button) getView().findViewById(R.id.worker_lm_btnClear);
        btnMainActivity = (Button) getView().findViewById(R.id.worker_lm_btnMainActivity);
    }
